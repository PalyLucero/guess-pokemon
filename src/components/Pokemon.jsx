...
export default function Pokemon({ pokemon, setPointer, pointer, cluePointer, setClue, fullClues, gameDone, setGameDone }) {
  ...
  }, [correct, skipped, pointer, setPointer, skippedCount])
        ...
        gameDone ?
          ...
          <div >
            <div className='flex justify-between rounded p-2 w-full'>
              <Timer correct={correct} setRemainingTime={setRemainingTime} gameDone={gameDone} setGameDone={setGameDone} />
              <Score remainingTime={remainingTime} skippedCount={skippedCount} totalScore={totalScore} setTotalScore={setTotalScore} />
            </div>
